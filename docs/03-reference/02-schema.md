...
```yaml
# yaml-language-server: $schema=https://raw.githubusercontent.com/purisev/universal-helm-chart/v3.0.1/values.schema.json
deployments:
  api:
    image:
      repository: nginx
...
- **Schema file or URL:** `https://raw.githubusercontent.com/purisev/universal-helm-chart/v3.0.1/values.schema.json`
